...
export const addCollectionAndDocuments = async (
  ...
  objectsToAdd.forEach((object) => {
    const docRef = doc(collectionRef, object.title.toLowerCase()); // if no third arguement is passed 2nd argument is used as name
...
export const createUserDocumentFromAuth = async (
  ...
  const userDocRef = doc(db, "users", userAuth.uid); // third argument is used as the name of the document(s) created
